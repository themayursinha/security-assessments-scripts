...
if __name__ == '__main__':
  ...
  source = input("Your IP address or the server you would like to spoof: ")
  target = input("The IP address of the server you wish to scan: ")
  port_range = input("The port range you wish to scan (1-2000): ")
  threads = input("The number of threads would you like to scan with: ")
